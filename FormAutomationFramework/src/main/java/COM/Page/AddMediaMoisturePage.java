...
public class AddMediaMoisturePage {

    private AndroidDriver driver;

    @FindBy(xpath = "//android.widget.TextView[@text=\"Media Moisture\"]")
    private WebElement mediaMoisture;
    ...
    @FindBy(xpath = "//android.widget.EditText[@resource-id=\"percent-0-5\"]")
    private WebElement percentField;

    @FindBy(xpath = "//android.widget.EditText[@resource-id=\"date-0-6\"]")
    ...
    public AddMediaMoisturePage(AndroidDriver driver) {
        this.driver = driver;
        PageFactory.initElements(driver, this);
    }

    public void openMediaMoistureForm() {
        mediaMoisture.click();
        iconButton.click();
    }

    public void fillMediaMoistureForm(String dome, String line, String set, String chamber,
                                      String position, String percent, String date) {
